...
def sentiment_vader(sentence):
    ...
    return negative, neutral, positive, compound, overall_sentiment, rating
...
for feat, label in data:
    negative, neutral, positive, compound, overall_sentiment, rating = sentiment_vader(feat)
    ...
    if(overall_sentiment == label):
        ...
        print(f'NEG: {negative}, NEUTRAL: {neutral}, POS: {positive} and RAT: {overall_sentiment}, LABEL: {label}')
